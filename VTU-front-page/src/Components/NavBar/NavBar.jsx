...
function NavBar() {
    ...
    return (
        <>
            <a href={"#"}>
                <img className={styles.logo} alt="logo image" src={Logo}/></a>
            ...
            <nav>
                <ul>
                    <li><a href={"#"} className={`${styles.link} ${styles.firstLink}`}>{t('ВТУ')}</a>
                    ...
                    <li><a href={"#"} className={styles.link}>{t('Центрове')}</a>
                        <ul className={styles.dropdown}>
                            ...
                            <li><a href={"#"}>{t("Център по икономически и управленски науки")}</a></li>
